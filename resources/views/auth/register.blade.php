    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header">{{ isset($url) ? ucwords($url) : ""}} {{ __('Enregistrement') }}</div>
                <div class="card-body">

                     @isset($url)
                    <form class="form-horizontal" method="POST" action='{{ url("register/$url") }}' aria-label="{{ __('Enregistrement') }}">
                        @csrf
                    ...
                    @else
                    <form class="form-horizontal" method="POST" action='{{ url("register") }}' aria-label="{{ __('Enregistrement') }}">
                        @csrf
